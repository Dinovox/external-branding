...
| :----------- | :-------------------------------------------- | :------------------- | :----------------- | :-------- |
| `logo.png`   | Avatar rond/carré dans les listes et en-têtes | PNG ou JPG (carré)   | 500x500 px         | < 200 Ko  |
| `banner.png` | Image large en fond d'écran de l'en-tête      | PNG ou JPG (paysage) | 1600x400 px        | < 500 Ko  |
